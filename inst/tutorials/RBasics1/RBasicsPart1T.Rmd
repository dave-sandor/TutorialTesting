...
I encourage you to take notes as you work through the tutorials. This will provide a help sheet to reference when you need to write your own code from scratch in class, for labs, or for your final project.
...
* How to assign a value or values to an object
* How to use functions
* How to determine the class of an object
* How to create and use vectors
