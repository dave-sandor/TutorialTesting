...
![from main images folder](/images/DataEx.png)
![from images folder within tutorial folder] (/images/DataEx.png)
![from images within tutorial folder] (/DataEx.png)
![From Local directory](/cloud/project/DataEx.png)
![From GitHub](https://github.com/dave-sandor/TutorialTesting/raw/master/images/DataEx.png){width=70%}
...
load("/cloud/project/counties2016.RData", verbose=TRUE)
```
