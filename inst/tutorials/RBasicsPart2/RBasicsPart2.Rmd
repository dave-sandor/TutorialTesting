...
* How to read in comma separted or .csv files
* How to read in R data or .RData files
...
UN.FB.posts <- import("/Users/sld8/Dropbox/PLSC309/FA2019/RNotebooks/Introduction/unitednations.csv")
#Tab delimited (.txt) file
turnout <- import("/Users/sld8/Dropbox/PLSC309/FA2020/RTutorials/turnout.txt")
#Stata (.dta) file
oil <- import("/Users/sld8/Dropbox/PLSC309/FA2020/RTutorials/oilwomen.dta")
```
...
How could you determine how many posts were published, on average, per day in 2015?

```{r howmany, exercise=TRUE}
...
save(UN.FB.posts, file="/Users/sld8/Dropbox/PLSC309/FA2019/RNotebooks/Introduction/Session1Data.Rdata")  # This saves the object UN.FB.posts as an R data set.
```

If we had created new objects separate from those in **UN.FB.posts**, saving **UN.FB.posts** will not save them. We will revisit techniques for saving multiple objects later in the semester.
